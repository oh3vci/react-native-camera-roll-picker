...
class CameraRollPicker extends Component {
    ...
    renderImage(item) {
        ...
        const selectedNum = selected.findIndex(item) + 1;
    ...
    renderRow(item, selectedItem) { // item is an array of objects
    ...
    render() {
        ...
        const flatListOrEmptyText = this.state.data.length > 0 ? (
            <FlatList
                ...
                renderItem={({ item }) => this.renderRow(item, this.state.selected)}
